...
Заказ принят.
> orders list -u 1
Заказ: 2. Получатель: 1. Хранится до 2024-06-02 10:02:08.180776081 +0000 UTC. Статус: Принят
Заказ: 1. Получатель: 1. Хранится до 2024-06-02 10:02:01.422463267 +0000 UTC. Статус: Принят
> orders list -u 2
...
// теперь же заказ находится физически в пвз
```